...
const Match = () => {
	...
	useEffect(() => {
		axios
			.post(`${config.baseUrl}/${config.matchNotStarted}`, {
				sport: "d56d7673-5e04-46a4-843c-65f1545c19c9",
			})
			.then((res) => {
				console.log(res.data);
				setPlayers(res.data.data.football);
			})
							...
							<td>
								{editingPlayer === player.uuid ? (
									<input
										...
										value={player.when}
										onChange={(event) =>
											handleEditChange(event, player.uuid, "when")
										}
									/>
								) : (
									player.when
							...
							<td>
								{editingPlayer === player.uuid ? (
									<input
										...
										value={player.status}
										onChange={(event) =>
											handleEditChange(event, player.uuid, "status")
										}
									/>
								) : (
									player.status
							...
							<td>
								{editingPlayer === player.uuid ? (
									<input
										...
										onChange={(event) =>
											handleEditChange(event, player.uuid, "channel")
										}
									/>
								) : (
									player.channel
							...
							<td>
								{editingPlayer === player.uuid ? (
									<input
										...
										value={player.round}
										onChange={(event) =>
											handleEditChange(event, player.uuid, "round")
										}
									/>
								) : (
									player.round
							...
							<td>
								{editingPlayer === player.uuid ? (
									<input
										...
										onChange={(event) =>
											handleEditChange(event, player.uuid, "play_ground")
										}
									/>
								) : (
									player.play_ground
							...
							<td>
								{editingPlayer === player.uuid ? (
									<input
										...
										onChange={(event) =>
											handleEditChange(event, player.uuid, "club1_id")
										}
									/>
								) : (
									player.club1_id
							...
							<td>
								{editingPlayer === player.uuid ? (
									<input
										...
										onChange={(event) =>
											handleEditChange(event, player.uuid, "club2_id")
										}
									/>
								) : (
									player.club2_id
							...
							<td>
								{editingPlayer === player.uuid ? (
									<input
										...
										onChange={(event) =>
											handleEditChange(event, player.uuid, "season_id")
										}
									/>
								) : (
									player.season_id
